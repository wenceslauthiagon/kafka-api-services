...
import { WebhookType } from '@zro/api-users/infrastructure';
import {
  AuthWalletParam,
  WalletApiHeader,
} from '@zro/operations/infrastructure';

class GetAllPixDevolutionReceivedByWalletParams extends PaginationParams {
  @ApiPropertyOptional({
...
class GetAllPixDevolutionReceivedByWalletRestResponseItem {
  @ApiProperty({
  ...
  constructor(props: GetAllPixDevolutionReceivedByWalletResponseItem) {
    ...
    this.type = WebhookType.DEVOLUTION_RECEIVED;
    ...
    this.owner_document =
      props.thirdPartPersonType === PersonDocumentType.CPF
        ...
        : cnpjMask(props.thirdPartDocument);
    ...
    this.beneficiary_document =
      props.clientPersonType === PersonDocumentType.CPF
        ...
        : cnpjMask(props.clientDocument);
    this.beneficiary_bank_name = props.clientBankName;
    this.created_at = props.createdAt;
  }
}

class GetAllPixDevolutionReceivedByWalletRestResponse extends PaginationRestResponse {
  @ApiProperty({
    description: 'PixDevolutionReceiveds data.',
    type: [GetAllPixDevolutionReceivedByWalletRestResponseItem],
  })
  data!: GetAllPixDevolutionReceivedByWalletRestResponseItem[];

  constructor(props: GetAllPixDevolutionReceivedByWalletResponse) {
    super(props);
    this.data = props.data.map(
      (item) => new GetAllPixDevolutionReceivedByWalletRestResponseItem(item),
    );
  }
}
...
@HasPermission('api-users-get-pix-devolutions-received')
export class GetAllPixDevolutionReceivedRestController {
  ...
  @ApiOkResponse({
    ...
    type: GetAllPixDevolutionReceivedByWalletRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Query() query: GetAllPixDevolutionReceivedByWalletParams,
    ...
    logger: Logger,
  ): Promise<GetAllPixDevolutionReceivedByWalletRestResponse> {
    // GetAll payload.
    ...
    const response = new GetAllPixDevolutionReceivedByWalletRestResponse(
      result,
    );
