...
export class CreateQrCodeDynamicChangeBody {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Change value in R$ cents',
    example: 2300,
  })
  @IsInt()
  @Min(0)
...
export class CreateQrCodeDynamicChangeRestResponse {
  @ApiProperty({
  ...
  /*constructor(props: CreateQrCodeDynamicChangeResponse) {
    this.id = props.id;
...
@ApiBearerAuth()
@DefaultApiHeaders()
@Controller('pix/deposits/qr-codes/dynamic/change')
@HasPermission('api-users-post-pix-deposits-qr-codes-dynamic-change')
export class CreateQrCodeDynamicChangeRestController {
  /**
   * create change dynamic QRCode endpoint.
   */
  @ApiOperation({
    summary: 'Create a change dynamic QR Code. (DO NOT WORKING YET)',
    description: 'Create a change dynamic QR Code.',
    deprecated: true,
  })
  @ApiCreatedResponse({
    description: 'The created QR Code returned successfully.',
    type: CreateQrCodeDynamicChangeRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @LoggerParam(CreateQrCodeDynamicChangeRestController)
    logger: Logger,
    @Body() body: CreateQrCodeDynamicChangeBody,
  ): Promise<CreateQrCodeDynamicChangeRestResponse> {
