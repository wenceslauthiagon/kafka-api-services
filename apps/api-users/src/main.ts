...
import { WalletGuard, PermissionGuard } from '@zro/operations/infrastructure';
import { AppModule } from '@zro/api-users/infrastructure/nest/modules/app.module';
...
async function bootstrap() {
  ...
  app.useGlobalGuards(
    ...
    new PermissionGuard(reflector, logger),
  );
...
function openapi() {
  const config = new DocumentBuilder()
    .setTitle('Z.ro Bank Users API')
    .setDescription('Z.ro Bank Users API')
