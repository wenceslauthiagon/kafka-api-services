...
const actions = [
  {
    tag: 'api-users-get-otc-portfolio-statements',
    description: "Get user's portfolio statement",
  },
  {
    tag: 'api-users-get-storage-files-download-by-id',
    description: 'Download storage file by ID',
  },
];
