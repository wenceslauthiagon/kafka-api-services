...
import {
  SyncP2PTransfersReportsCronService as Cron,
  CurrencyModel,
  OperationModel,
  SyncP2PTransfersReportsCronConfig,
...
describe('SyncP2PTransfersReportsCronService', () => {
  ...
  beforeAll(async () => {
    ...
    const configService: ConfigService<SyncP2PTransfersReportsCronConfig> =
