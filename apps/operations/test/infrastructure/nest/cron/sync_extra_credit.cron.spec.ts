...
import {
  SyncExtraCreditsReportsCronService as Cron,
  CurrencyModel,
  OperationModel,
  SyncExtraCreditsReportsCronConfig,
...
describe('SyncExtraCreditsReportsCronService', () => {
  ...
  beforeAll(async () => {
    ...
    const configService: ConfigService<SyncExtraCreditsReportsCronConfig> =
