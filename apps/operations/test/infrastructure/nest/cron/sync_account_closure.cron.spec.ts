...
import {
  SyncAccountsClosuresReportsCronService as Cron,
  CurrencyModel,
  OperationModel,
  SyncAccountsClosuresReportsCronConfig,
...
describe('SyncAccountsClosuresReportsCronService', () => {
  ...
  beforeAll(async () => {
    ...
    const configService: ConfigService<SyncAccountsClosuresReportsCronConfig> =
