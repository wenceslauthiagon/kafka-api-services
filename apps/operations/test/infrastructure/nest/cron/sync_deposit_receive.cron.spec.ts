...
import {
  SyncDepositsReceiveReportsCronService as Cron,
  CurrencyModel,
  OperationModel,
  SyncDepositsReceiveReportsCronConfig,
...
describe('SyncDepositsReceiveReportsCronService', () => {
  ...
  beforeAll(async () => {
    ...
    const configService: ConfigService<SyncDepositsReceiveReportsCronConfig> =
