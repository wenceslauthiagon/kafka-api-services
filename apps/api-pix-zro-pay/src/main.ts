...
import { AppModule } from 'apps/api-pix-zro-pay/src/infrastructure/nest/modules/app.module';
...
function openapi() {
  const config = new DocumentBuilder()
    .setTitle('Z.ro Bank Pix Zro Pay API')
    .setDescription('Z.ro Bank Pix Zro Pay API')
    ...
    .addBearerAuth({ type: 'apiKey', name: 'x-api-key', in: 'header' })
    .build();
