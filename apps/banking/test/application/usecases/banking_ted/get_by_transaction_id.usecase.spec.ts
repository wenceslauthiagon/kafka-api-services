...
describe('GetBankingTedByTransactionIdUseCase', () => {
  ...
  describe('With valid parameters', () => {
    it('TC0001 - Should get bankingTed successfully by transactionId', async () => {
      ...
      const result = await usecase.execute(bankingTed.transactionId);
  ...
  describe('With invalid parameters', () => {
    it('TC0002 - Should not get bankingTed by transactionId is not valid', async () => {
      const usecase = new UseCase(logger, bankingTedRepository);
