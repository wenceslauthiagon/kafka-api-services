...
import {
  BankingTedModel,
  GetBankingTedByIdMicroserviceController as Controller,
...
import { GetBankingTedByIdRequest } from '@zro/banking/interface';

describe('GetBankingTedByIdMicroserviceController', () => {
  ...
  describe('GetBankingTedById', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should get bankingTed by id successfully', async () => {
        ...
        const message: GetBankingTedByIdRequest = {
          id: bankingTed.id,
        };
