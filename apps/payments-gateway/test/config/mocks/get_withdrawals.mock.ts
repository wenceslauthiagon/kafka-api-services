...
export const success = () => {
  const data = {
    data: [
      {
        id: 24709,
        reference: '3c56852b-5b26-49a7-80ce-accdc3610bec',
        main_transaction: 'b734429f83914e909ff931837ae4a309',
        uuid: '690958a8-99c4-4f45-ba14-6f1f9781bdba',
        description: 'PIX',
        payment_type: 'pix',
        status: 'pending',
        type_key_pix: 'evp',
        ...
        fee_value: '0,25',
        value: '13,84',
        created_at: '2023-02-15T19:34:30+00:00',
        updated_at: '2023-02-15T19:34:33+00:00',
    ...
    links: {
      first:
        'http://sandbox-api-admin-payments.zrobank.xyz/api/transactions/withdraws?page=1',
      last: 'http://sandbox-api-admin-payments.zrobank.xyz/api/transactions/withdraws?page=1',
      prev: null,
      next: null,
    },
    meta: {
      ...
      links: [
        ...
        {
          url: 'http://sandbox-api-admin-payments.zrobank.xyz/api/transactions/withdraws?page=1',
          label: '1',
          active: true,
        },
        {
      ...
      path: 'http://sandbox-api-admin-payments.zrobank.xyz/api/transactions/withdraws',
      per_page: 15,
      to: 2,
      total: 2,
    },
