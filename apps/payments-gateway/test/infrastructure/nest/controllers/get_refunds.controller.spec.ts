...
import { GetRefundsRequest } from '@zro/payments-gateway/interface';
import {
  GetRefundsMicroserviceController as Controller,
...
import * as MockGetRefunds from '@zro/test/payments-gateway/config/mocks/get_refunds.mock';
...
describe('GetRefundsMicroserviceController', () => {
  ...
  describe('With valid parameters', () => {
    it('TC0001 - Should get refunds successfully', async () => {
      mockCreateAxiosService.mockReturnValue(mockAxios);
      mockAxios.get.mockImplementationOnce(MockGetRefunds.success);

      const message: GetRefundsRequest = {
        wallet_id: uuidV4(),
      };
  ...
  describe('With invalid parameters', () => {
    it('TC0002 - Should not get refunds after offline response', async () => {
      mockCreateAxiosService.mockReturnValue(mockAxios);
      mockAxios.get.mockImplementationOnce(MockGetRefunds.offline);
    ...
    it('TC0003 - Should not get refunds after unauthorized response', async () => {
      mockCreateAxiosService.mockReturnValue(mockAxios);
      mockAxios.get.mockImplementationOnce(MockGetRefunds.unauthorized);
