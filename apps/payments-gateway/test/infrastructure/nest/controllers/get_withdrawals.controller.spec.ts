...
import { GetWithdrawalsRequest } from '@zro/payments-gateway/interface';
import {
  GetWithdrawalsMicroserviceController as Controller,
  PaymentsGatewayAxiosService,
} from '@zro/payments-gateway/infrastructure';
import * as MockGetWithdrawals from '@zro/test/payments-gateway/config/mocks/get_withdrawals.mock';
...
describe('GetWithdrawalsMicroserviceController', () => {
  ...
  describe('With valid parameters', () => {
    it('TC0001 - Should get withdrawals successfully', async () => {
      mockCreateAxiosService.mockReturnValue(mockAxios);
      mockAxios.get.mockImplementationOnce(MockGetWithdrawals.success);

      const message: GetWithdrawalsRequest = {
        wallet_id: uuidV4(),
      };
  ...
  describe('With invalid parameters', () => {
    it('TC0002 - Should not get withdrawals after offline response', async () => {
      mockCreateAxiosService.mockReturnValue(mockAxios);
      mockAxios.get.mockImplementationOnce(MockGetWithdrawals.offline);
    ...
    it('TC0003 - Should not get withdrawals after unauthorized response', async () => {
      mockCreateAxiosService.mockReturnValue(mockAxios);
      mockAxios.get.mockImplementationOnce(MockGetWithdrawals.unauthorized);
