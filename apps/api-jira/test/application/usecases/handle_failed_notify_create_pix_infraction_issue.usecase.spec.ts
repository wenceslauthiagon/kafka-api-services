...
import {
  HandleFailedNotifyCreatePixInfractionIssueEventUseCase as UseCase,
...
describe('HandleFailedNotifyCreatePixInfractionIssueEventUseCase', () => {
  ...
  describe('With valid parameters', () => {
    it('TC0001 - Should handle notify failed create issue and save in database', async () => {
      const {
        sut,
        mockErrorNotifyPixInfractionIssueEventEmitter,
        mockCreateNotifyPixInfractionIssueRepository,
