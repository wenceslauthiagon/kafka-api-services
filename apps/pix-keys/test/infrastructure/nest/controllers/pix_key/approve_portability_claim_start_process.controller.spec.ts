...
import {
  PixKeyModel,
  ApprovePortabilityClaimStartProcessMicroserviceController as Controller,
...
describe('ApprovePortabilityClaimStartProcessMicroserviceController', () => {
  ...
  describe('ApprovePortabilityClaimStartProcess', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should start process successfully', async () => {
        ...
        const message: ApprovePortabilityClaimStartProcessRequest = {
          userId,
          id,
        };
