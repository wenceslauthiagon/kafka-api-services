...
import {
  PixKeyModel,
  CancelStartPortabilityProcessByIdPixKeyMicroserviceController as Controller,
...
import { CancelStartPortabilityProcessByIdPixKeyRequest } from '@zro/pix-keys/interface';
import { KafkaContext } from '@nestjs/microservices';

describe('CancelStartPortabilityProcessByIdPixKeyMicroserviceController', () => {
  ...
  describe('CancelStartPortabilityProcessByIdPixKey', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should cancel a process successfully', async () => {
        ...
        const message: CancelStartPortabilityProcessByIdPixKeyRequest = {
          userId,
          id,
        };
