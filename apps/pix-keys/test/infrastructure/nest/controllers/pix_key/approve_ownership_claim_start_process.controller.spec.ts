...
import {
  PixKeyModel,
  ApproveOwnershipClaimStartProcessMicroserviceController as Controller,
...
describe('ApproveOwnershipClaimStartProcessMicroserviceController', () => {
  ...
  describe('ApproveOwnershipClaimStartProcess', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should start process successfully', async () => {
        ...
        const message: ApproveOwnershipClaimStartProcessRequest = {
          userId,
          id,
        };
        ...
        expect(mockEmitPixKeyEvent.mock.calls[0][0]).toBe(
          PixKeyEventType.OWNERSHIP_OPENED,
        );
      });
