...
export class CancelStartPortabilityProcessByIdPixKeyUseCase {
  /**
   * Default constructor.
  ...
  constructor(
    ...
    this.logger = logger.child({
      context: CancelStartPortabilityProcessByIdPixKeyUseCase.name,
    });
  }

  /**
   * Cancel the start portability process of pixKey by user and id.
   *
