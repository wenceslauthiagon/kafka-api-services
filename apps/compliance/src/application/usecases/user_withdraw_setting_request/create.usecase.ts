...
export class CreateUserWithdrawSettingRequestUseCase {
  /**
   * Default constructor.
  ...
  constructor(
    ...
    this.logger = logger.child({
      context: CreateUserWithdrawSettingRequestUseCase.name,
    });
  }
  ...
  private async saveAndEmitPendingEvent(
    userWithdrawSettingRequest: UserWithdrawSettingRequest,
  ): Promise<UserWithdrawSettingRequest> {
    ...
    this.eventEmitter.pending(userWithdrawSettingsRequestCreated);
  ...
  private async create(
    ...
    return this.saveAndEmitPendingEvent(userWithdrawSettingRequest);
  }
