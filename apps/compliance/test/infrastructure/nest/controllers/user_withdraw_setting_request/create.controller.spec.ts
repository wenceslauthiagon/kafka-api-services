...
import { OperationService, PixKeyService } from '@zro/compliance/application';
import {
  CreateUserWithdrawSettingRequest,
  UserWithdrawSettingRequestEventEmitterControllerInterface,
} from '@zro/compliance/interface';
import {
  CreateUserWithdrawSettingRequestMicroserviceController as Controller,
...
describe('CreateUserWithdrawSettingRequestMicroserviceController', () => {
  ...
  describe('CreateUserWithdrawSettingRequest', () => {
