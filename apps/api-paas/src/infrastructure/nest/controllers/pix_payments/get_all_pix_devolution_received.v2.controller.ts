...
class V2GetAllPixDevolutionReceivedParams extends PaginationParams {
  @ApiPropertyOptional({
...
class V2GetAllPixDevolutionReceivedRestResponseItem {
  @ApiProperty({
  ...
  constructor(props: GetAllPixDevolutionReceivedByWalletResponseItem) {
    ...
    this.type = V2WebhookType.DEVOLUTION_RECEIVED;
...
class V2GetAllPixDevolutionReceivedRestResponse extends PaginationRestResponse {
  @ApiProperty({
    description: 'PixDevolutionReceiveds data.',
    type: [V2GetAllPixDevolutionReceivedRestResponseItem],
  })
  data!: V2GetAllPixDevolutionReceivedRestResponseItem[];

  constructor(props: GetAllPixDevolutionReceivedByWalletResponse) {
    super(props);
    this.data = props.data.map(
      (item) => new V2GetAllPixDevolutionReceivedRestResponseItem(item),
    );
  }
}
...
export class V2GetAllPixDevolutionReceivedRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V2GetAllPixDevolutionReceivedRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Query() query: V2GetAllPixDevolutionReceivedParams,
    ...
    @LoggerParam(V2GetAllPixDevolutionReceivedRestController)
    logger: Logger,
  ): Promise<V2GetAllPixDevolutionReceivedRestResponse> {
    // GetAll payload.
    ...
    const response = new V2GetAllPixDevolutionReceivedRestResponse(result);
