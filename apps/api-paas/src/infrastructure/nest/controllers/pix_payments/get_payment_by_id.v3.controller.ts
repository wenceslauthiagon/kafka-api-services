...
export class V3GetPaymentByIdParams {
  @ApiProperty({
...
export class V3GetPaymentByIdRestResponse {
  @ApiProperty({
    description: 'Payment UUID.',
...
export class V3GetPaymentByIdRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V3GetPaymentByIdRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Param() params: V3GetPaymentByIdParams,
    @KafkaServiceParam(GetPaymentByIdServiceKafka)
    service: GetPaymentByIdServiceKafka,
    @LoggerParam(V3GetPaymentByIdRestController)
    logger: Logger,
  ): Promise<V3GetPaymentByIdRestResponse> {
    // Create a payload.
    ...
    const response = result && new V3GetPaymentByIdRestResponse(result);
