...
class V3GetAllPixDevolutionParams extends PaginationParams {
  @ApiPropertyOptional({
...
class V3GetAllPixDevolutionRestResponseItem {
  @ApiProperty({
  ...
  constructor(props: GetAllPixDevolutionByWalletResponseItem) {
    ...
    this.type = V3WebhookType.DEVOLUTION_COMPLETED;
...
class V3GetAllPixDevolutionRestResponse extends PaginationRestResponse {
  @ApiProperty({
    description: 'PixDevolutions data.',
    type: [V3GetAllPixDevolutionRestResponseItem],
  })
  data!: V3GetAllPixDevolutionRestResponseItem[];

  constructor(props: GetAllPixDevolutionByWalletResponse) {
    super(props);
    this.data = props.data.map(
      (item) => new V3GetAllPixDevolutionRestResponseItem(item),
    );
  }
}
...
export class V3GetAllPixDevolutionRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V3GetAllPixDevolutionRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Query() query: V3GetAllPixDevolutionParams,
    ...
    @LoggerParam(V3GetAllPixDevolutionRestController)
    logger: Logger,
  ): Promise<V3GetAllPixDevolutionRestResponse> {
    // GetAll payload.
    ...
    const response = new V3GetAllPixDevolutionRestResponse(result);
