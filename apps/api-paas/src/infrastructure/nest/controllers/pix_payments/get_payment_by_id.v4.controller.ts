...
export class V4GetPaymentByIdParams {
  @ApiProperty({
...
export class V4GetPaymentByIdRestResponse {
  @ApiProperty({
    description: 'Payment UUID.',
  ...
  @ApiPropertyOptional({
    description: 'Error code returned when payment is reverted.',
    example: 'AG03',
    required: false,
    nullable: true,
  })
  ...
  @ApiPropertyOptional({
    description: 'Error description returned when payment is reverted.',
    example: 'Pagamento rejeitado pelo PSP do recebedor',
    required: false,
    nullable: true,
  })
...
export class V4GetPaymentByIdRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V4GetPaymentByIdRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Param() params: V4GetPaymentByIdParams,
    @KafkaServiceParam(GetPaymentByIdServiceKafka)
    service: GetPaymentByIdServiceKafka,
    @LoggerParam(V4GetPaymentByIdRestController)
    logger: Logger,
  ): Promise<V4GetPaymentByIdRestResponse> {
    // Create a payload.
    ...
    const response = result && new V4GetPaymentByIdRestResponse(result);
