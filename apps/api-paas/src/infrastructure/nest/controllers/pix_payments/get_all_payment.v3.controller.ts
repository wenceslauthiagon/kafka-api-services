...
class V3GetAllPaymentParams extends PaginationParams {
  @ApiPropertyOptional({
...
class V3GetAllPaymentRestResponseItem {
  @ApiProperty({
  ...
  constructor(props: GetAllPaymentByWalletResponseItem) {
    ...
    this.type = V3WebhookType.PAYMENT_COMPLETED;
...
class V3GetAllPaymentRestResponse extends PaginationRestResponse {
  @ApiProperty({
    description: 'Payments data.',
    type: [V3GetAllPaymentRestResponseItem],
  })
  data!: V3GetAllPaymentRestResponseItem[];

  constructor(props: GetAllPaymentByWalletResponse) {
    super(props);
    this.data = props.data.map(
      (item) => new V3GetAllPaymentRestResponseItem(item),
    );
  }
}
...
export class V3GetAllPaymentRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V3GetAllPaymentRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Query() query: V3GetAllPaymentParams,
    @KafkaServiceParam(GetAllPaymentByWalletServiceKafka)
    getAllPaymentService: GetAllPaymentByWalletServiceKafka,
    @LoggerParam(V3GetAllPaymentRestController)
    logger: Logger,
  ): Promise<V3GetAllPaymentRestResponse> {
    // GetAll payload.
    ...
    const response = new V3GetAllPaymentRestResponse(result);
