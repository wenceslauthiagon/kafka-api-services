...
class V3GetAllPixDepositParams extends PaginationParams {
  @ApiPropertyOptional({
...
class V3GetAllPixDepositRestResponseItem {
  @ApiProperty({
  ...
  constructor(props: GetAllPixDepositByWalletResponseItem) {
    ...
    this.type = V3WebhookType.DEPOSIT_RECEIVED;
...
class V3GetAllPixDepositRestResponse extends PaginationRestResponse {
  @ApiProperty({
    description: 'PixDeposits data.',
    type: [V3GetAllPixDepositRestResponseItem],
  })
  data!: V3GetAllPixDepositRestResponseItem[];

  constructor(props: GetAllPixDepositByWalletResponse) {
    super(props);
    this.data = props.data.map(
      (item) => new V3GetAllPixDepositRestResponseItem(item),
    );
  }
}
...
export class V3GetAllPixDepositRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V3GetAllPixDepositRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Query() query: V3GetAllPixDepositParams,
    @KafkaServiceParam(GetAllPixDepositByWalletServiceKafka)
    getAllPixDepositService: GetAllPixDepositByWalletServiceKafka,
    @LoggerParam(V3GetAllPixDepositRestController)
    logger: Logger,
  ): Promise<V3GetAllPixDepositRestResponse> {
    // GetAll payload.
    ...
    const response = new V3GetAllPixDepositRestResponse(result);
