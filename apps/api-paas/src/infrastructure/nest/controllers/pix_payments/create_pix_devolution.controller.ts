...
class CreatePixDevolutionBody {
  @ApiProperty({
    description:
      'Credit statement ID. Statement to be charged back. Now it is operation_id. This ID is used to get receipt and track the transaction.',
...
@HasPermission('api-paas-post-pix-devolutions')
