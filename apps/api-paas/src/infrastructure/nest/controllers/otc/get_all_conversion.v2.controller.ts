...
class V2GetAllConversionParams extends PaginationParams {
  @ApiPropertyOptional({
...
class V2GetAllConversionRestResponseItem {
  @ApiProperty({
...
class V2GetAllConversionRestResponse extends PaginationRestResponse {
  @ApiProperty({
    description: 'Conversion data.',
    type: [V2GetAllConversionRestResponseItem],
  })
  data!: V2GetAllConversionRestResponseItem[];

  constructor(props: GetAllConversionResponse) {
    super(props);
    this.data = props.data.map(
      (item) => new V2GetAllConversionRestResponseItem(item),
    );
  }
}
...
export class V2GetAllConversionRestController {
  /**
  ...
  @ApiOkResponse({
    ...
    type: V2GetAllConversionRestResponse,
  })
  @ApiUnauthorizedResponse({
  ...
  async execute(
    ...
    @Query() query: V2GetAllConversionParams,
    @KafkaServiceParam(GetAllConversionServiceKafka)
    getAllConversionService: GetAllConversionServiceKafka,
    @LoggerParam(V2GetAllConversionRestController)
    logger: Logger,
  ): Promise<V2GetAllConversionRestResponse> {
    // GetAll payload.
    ...
    const response = new V2GetAllConversionRestResponse(result);
