...
export class GetAllBankTedParams extends PaginationParams {
  @ApiPropertyOptional({
...
export class GetAllBankTedRestResponse extends PaginationRestResponse {
  @ApiProperty({
...
@HasPermission('api-paas-get-banking-ted-banks')
export class GetAllBankTedRestController {
  /**
   * get bank endpoint.
   */
  @ApiOperation({
    summary: 'List banks that support TED operations.',
    description:
