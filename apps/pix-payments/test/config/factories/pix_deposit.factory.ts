 ...
 * PixDeposit factory.
 */
factory.define<PixDepositModel>(PixDepositModel.name, PixDepositModel, () => {
  return {
    ...
    thirdPartBankIspb: faker.datatype.number(99999).toString().padStart(8, '0'),
...
/**
 * PixDeposit entity factory.
 */
const objectAdapter = new ObjectAdapter();
factory.setAdapter(objectAdapter, PixDepositEntity.name);

factory.define<PixDepositEntity>(
  ...
  {
    afterBuild: (model) => {
      return new PixDepositEntity(model);
    },
  },
);

export const PixDepositFactory = factory;
