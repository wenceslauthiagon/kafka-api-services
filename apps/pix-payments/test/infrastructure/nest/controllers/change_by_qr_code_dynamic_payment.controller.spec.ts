...
import {
  ChangeByQrCodeDynamicPaymentMicroserviceController as Controller,
...
describe('ChangeByQrCodeDynamicPaymentMicroserviceController', () => {
  ...
  describe('ChangeByQrCodeDynamicPayment', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should change by qr code dynamic pending successfully', async () => {
        ...
        const message: ChangeByQrCodeDynamicPaymentRequest = {
    ...
    describe('With invalid parameters', () => {
      it('TC0002 - should dont change payment when user is forbidden', async () => {
        const user = new UserEntity({
          id: faker.datatype.number({ min: 1, max: 99999 }),
          uuid: faker.datatype.uuid(),
        });
