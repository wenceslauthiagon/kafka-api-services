...
import {
  CreateByQrCodeStaticPaymentMicroserviceController as Controller,
...
describe('CreateByQrCodeStaticPaymentMicroserviceController', () => {
  ...
  describe('CreateByQrCodeStaticPayment', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should create by qr code static pending successfully', async () => {
        ...
        const { value } = await PaymentFactory.create<PaymentModel>(
          PaymentModel.name,
          { userId: user.uuid },
        );
        const decodedQrCode =
        ...
        const message: CreateByQrCodeStaticPaymentRequest = {
      ...
      it('TC0002 - Should create by qr code static schedule successfully', async () => {
        const user = new UserEntity({
          id: faker.datatype.number({ min: 1, max: 99999 }),
          uuid: faker.datatype.uuid(),
          type: PersonType.NATURAL_PERSON,
    ...
    describe('With invalid parameters', () => {
      it('TC0003 - should dont create payment when value is invalid', async () => {
        const user = new UserEntity({
          id: faker.datatype.number({ min: 1, max: 99999 }),
          uuid: faker.datatype.uuid(),
          type: PersonType.NATURAL_PERSON,
