...
import {
  WithdrawalByQrCodeDynamicPaymentMicroserviceController as Controller,
...
describe('WithdrawalByQrCodeDynamicPaymentMicroserviceController', () => {
  ...
  describe('WithdrawalByQrCodeDynamicPayment', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should withdrawal by qr code dynamic pending successfully', async () => {
        ...
        const message: WithdrawalByQrCodeDynamicPaymentRequest = {
    ...
    describe('With invalid parameters', () => {
      it('TC0002 - should dont withdrawal payment when user is forbidden', async () => {
        const user = new UserEntity({
          id: faker.datatype.number({ min: 1, max: 99999 }),
          uuid: faker.datatype.uuid(),
        });
