...
import { WarningPixDepositIsCefNestObserver as Observer } from '@zro/pix-payments/infrastructure';
import {
...
const pixPaymentCEFIspb = '00360305';

describe('WarningPixDepositIsCefNestObserver', () => {
  ...
  describe('With invalid parameters', () => {
    it('TC0001 - Should not update pix deposit with missing params', async () => {
      const message: HandleWarningPixDepositIsCefEventRequest = {
        id: null,
        state: null,
        userId: null,
        walletId: null,
