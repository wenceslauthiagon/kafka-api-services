...
import {
  ClosePendingPixInfractionReceivedNestObserver as Observer,
...
describe('ClosePendingPixInfractionReceivedNestObserver', () => {
  ...
  describe('HandleClosePendingPixInfractionReceived', () => {
    describe('With invalid parameters', () => {
      it('TC0001 - Should not create if infraction no exists', async () => {
        const message: HandleClosePendingPixInfractionReceivedEventRequest = {
