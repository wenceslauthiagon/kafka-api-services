...
import { WarningPixDepositIsDuplicatedNestObserver as Observer } from '@zro/pix-payments/infrastructure';
import {
...
describe('WarningPixDepositIsDuplicatedNestObserver', () => {
  ...
  describe('With invalid parameters', () => {
    it('TC0001 - Should not update pix deposit with missing params', async () => {
      const message: HandleWarningPixDepositIsDuplicatedEventRequest = {
        id: null,
        state: null,
        userId: null,
        walletId: null,
