...
export class HandleCreateReportOperationByPixDepositReceivedEventUseCase {
  constructor(
    ...
    this.logger = logger.child({
      context: HandleCreateReportOperationByPixDepositReceivedEventUseCase.name,
    });
  }
  ...
  async execute(
    ...
    this.logger.debug('Added new report operation by pix deposit received.', {
