...
export class HandleCreateReportOperationByPixDevolutionConfirmedEventUseCase {
  constructor(
    ...
    this.logger = logger.child({
      context:
        HandleCreateReportOperationByPixDevolutionConfirmedEventUseCase.name,
    });
  }
  ...
  async execute(
    ...
    this.logger.debug(
      'Added new report operation by pix devolution confirmed.',
      {
