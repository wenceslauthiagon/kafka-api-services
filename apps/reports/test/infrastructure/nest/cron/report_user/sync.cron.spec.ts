...
import {
  SyncReportsUsersCronServiceInit as Cron,
  ReportUserModel,
...
describe('SyncReportsUsersCronServiceInit', () => {
  ...
  describe('Sync report user', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should sync report user successfully', async () => {
        ...
        await controller.syncReportsUsers();
