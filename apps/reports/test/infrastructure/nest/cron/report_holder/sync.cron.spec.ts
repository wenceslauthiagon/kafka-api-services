...
import {
  SyncReportsHoldersCronServiceInit as Cron,
  ReportUserModel,
...
describe('SyncReportsHoldersCronServiceInit', () => {
  ...
  describe('Sync report holders', () => {
    describe('With valid parameters', () => {
      it('TC0001 - Should sync report holders successfully', async () => {
        ...
        await controller.syncReportsHolders();
