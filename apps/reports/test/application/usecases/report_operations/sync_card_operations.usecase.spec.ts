...
describe('SyncCardOperationUseCase', () => {
  beforeEach(() => jest.resetAllMocks());

  const zroBankIspb = '26264220';
  const cardOperationTags = 'DEBITTRANSACTION';
  ...
  describe('With invalid parameters', () => {
    ...
    it('TC0003 - Should not create if no card operations is found.', async () => {
      const {
        sut,
        mockGetTransactionTypeByTagService,
        mockGetAllByFilterService,
  ...
  describe('With valid parameters', () => {
    it('TC0004 - Should create new Report Operation if card operation is found.', async () => {
      const {
        sut,
        mockGetTransactionTypeByTagService,
        mockGetAllByFilterService,
