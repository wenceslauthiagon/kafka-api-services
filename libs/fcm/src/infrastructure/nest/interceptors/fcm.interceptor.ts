...
@Injectable()
export class FcmInterceptor implements NestInterceptor {
  /**
   * Default constructor.
   * @param service Global FcmService instance
   */
  ...
  async intercept(
    ...
    request.fcmGateway = this.service.getFcmGateway(request.logger);
