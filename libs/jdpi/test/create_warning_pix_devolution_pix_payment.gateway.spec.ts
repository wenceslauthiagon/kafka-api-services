...
import * as MockJdpiCreateWarningPixDevolution from './mocks/create_pix_devolution.mock';
...
describe('PspGateway createWarningPixDevolution', () => {
  ...
  it('TC0001 - Should send createWarningPixDevolution successfully', async () => {
    mockAxios.post.mockImplementationOnce(
      MockJdpiCreateWarningPixDevolution.success,
    );
    ...
    const result = await pixService
      ...
      .createWarningPixDevolution(body);
  ...
  it('TC0002 - Should send createWarningPixDevolution after offline response', async () => {
    mockAxios.post.mockImplementationOnce(
      MockJdpiCreateWarningPixDevolution.offline,
    );
    ...
    const testScript = () =>
      pixService.getPixPaymentGateway().createWarningPixDevolution(body);
  ...
  it('TC0003 - Should send createWarningPixDevolution after unexpected error response', async () => {
    mockAxios.post.mockImplementationOnce(
      MockJdpiCreateWarningPixDevolution.unexpectedError,
    );
