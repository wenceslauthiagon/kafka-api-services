...
import * as MockJdpiCreatePixDevolutionRefund from './mocks/create_pix_devolution.mock';
...
describe('JdpiCreatePixDevolutionRefundPixPaymentPspGateway', () => {
  ...
  it('TC0001 - Should create a pix devolution refund successfully', async () => {
    mockAxios.post.mockImplementationOnce(
      MockJdpiCreatePixDevolutionRefund.success,
    );
    ...
    const result = await pixService
      ...
      .createPixDevolutionRefund(body);
  ...
  it('TC0002 - Should send createPixDevolution after offline response', async () => {
    mockAxios.post.mockImplementationOnce(
      MockJdpiCreatePixDevolutionRefund.offline,
    );
    ...
    const testScript = () =>
      pixService.getPixPaymentGateway().createPixDevolutionRefund(body);
  ...
  it('TC0003 - Should send createPixDevolution after unexpected error response', async () => {
    mockAxios.post.mockImplementationOnce(
      MockJdpiCreatePixDevolutionRefund.unexpectedError,
    );
