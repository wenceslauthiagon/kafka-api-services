...
import * as MockJdpiClosingClaim from './mocks/closing_claim_pix_key.mock';
...
describe('PspGateway closingClaim', () => {
  ...
  it('TC0001 - Should send closingClaim successfully', async () => {
    mockAxios.post.mockImplementationOnce(MockJdpiClosingClaim.success);
    ...
    const result = await pixKeyService.getPixKeyGateway().closingClaim(body);
  ...
  it('TC0002 - Should send closingClaim after offline response', async () => {
    mockAxios.post.mockImplementationOnce(MockJdpiClosingClaim.offline);
    ...
    const testScript = () =>
      pixKeyService.getPixKeyGateway().closingClaim(body);
  ...
  it('TC0003 - Should send confirmPortabilityClaim after unexpected error response', async () => {
    mockAxios.post.mockImplementationOnce(MockJdpiClosingClaim.unexpectedError);
