...
export interface JdpiCreateWarningPixDevolutionPixPaymentRequest {
...
export interface JdpiCreateWarningPixDevolutionPixPaymentResponse {
  idReqSistemaCliente: string;
  idReqJdPi: string;
  endToEndIdOriginal: string;
  endToEndIdDevolucao: string;
...
export class JdpiCreateWarningPixDevolutionPixPaymentPspGateway
  implements Pick<PixPaymentGateway, 'createWarningPixDevolution'>
{
  constructor(
    ...
    this.logger = logger.child({
      context: JdpiCreateWarningPixDevolutionPixPaymentPspGateway.name,
    });
  }
  ...
  async createWarningPixDevolution(
    ...
    const payload: JdpiCreateWarningPixDevolutionPixPaymentRequest = {
      ...
      codigoDevolucao: PixDevolutionCode.FRAUD,
    };
    ...
    try {
      const response =
        await this.axios.post<JdpiCreateWarningPixDevolutionPixPaymentResponse>(
