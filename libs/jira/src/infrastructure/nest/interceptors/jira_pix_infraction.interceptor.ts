...
@Injectable()
export class JiraPixInfractionInterceptor implements NestInterceptor {
  /**
   * Default constructor.
  ...
  /**
   * Intercept request and add a JiraPixInfractionGateway.
  ...
  async intercept(
    ...
    request.jiraPixInfractionGateway = this.service.getPixInfractionGateway(
      request.logger,
    );
