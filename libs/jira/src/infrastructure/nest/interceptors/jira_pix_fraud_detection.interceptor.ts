...
@Injectable()
export class JiraPixFraudDetectionInterceptor implements NestInterceptor {
  /**
   * Default constructor.
  ...
  /**
   * Intercept request and add a JiraPixFraudDetectionGateway.
  ...
  async intercept(
    ...
    request.jiraPixFraudDetectionGateway =
